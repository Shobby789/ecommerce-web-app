...
const ProductsList = () => {
  ...
  const url = searchValue !== "" ? `/products/search?q=${searchValue}` : `/products`;
  const { data, loading, error } = useFetch(url);
  useDocumentTitle("Dashboard - Products")
  ...
  return (
    <div className="w-full pb-10 bg-white rounded-lg border">
      ...
      {/* pagination */}
      <div aria-label="Page navigation" className="mt-8 flex justify-end px-10">
